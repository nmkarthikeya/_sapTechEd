sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("teched/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("teched.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["teched/localService/mockserver"], function (mockserver) {
