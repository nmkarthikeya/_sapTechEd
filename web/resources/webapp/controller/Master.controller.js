/*global history */
sap.ui.define([
		"teched/controller/BaseController",
		...
		"sap/ui/Device",
		"teched/model/formatter",
		"teched/model/grouper",
		"teched/model/GroupSortState"
		...
		return BaseController.extend("teched.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("teched.view.ViewSettingsDialog", this);
