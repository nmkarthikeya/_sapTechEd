sap.ui.define([
		...
		return BaseObject.extend("teched.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias teched.model.ListSelector
			 */
			 ...
			 * @return {teched.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
